...
import org.exthmui.settings.preferences.PackageListAdapter;
import org.exthmui.settings.preferences.PackageListAdapter.PackageItem;
...
public class PackageListPreference extends PreferenceCategory implements
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        if (preference == mAddPackagePref) {
            ...
            builder.setTitle(R.string.gaming.profile_choose_app);
            ...
            builder.setTitle(R.string.gaming.dialog_delete_title)
                .setMessage(R.string.gaming.dialog_delete_message)
